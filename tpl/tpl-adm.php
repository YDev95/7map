...
<body>
    ...
    <div class="main-panel">
        ...
        <div class="box">
            ...
            <a class="statusToggle" style="color: #007bec;" href="?verified=all">همه</a>
            <a class="statusToggle active" href="?verified=1">فعال</a>
            <a class="statusToggle" href="?verified=0">غیرفعال</a>
            <a class="statusToggle" href="?logout=1" style="float:left" target="_self">خروج</a>
        </div>
        <div class="box">
        ...
        <tr>
            <td><?=$loc->title?></td>
            <td class="text-center"><?=verta($loc->created_at)->format('%B %d، %Y');?></td>
